...
#a function that iterates (e.g. for, map, apply) vs a function that is iterated (e.g. myfunction(x) )
#showing people how to inspect what the function they want to use does.
