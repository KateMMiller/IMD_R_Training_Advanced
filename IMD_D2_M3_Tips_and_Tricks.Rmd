...
Adding comments to your code can help future users, including future you, understand what the code does and why you did it. However, comments are more work and too many comments can clutter your code with unhelpful information. Also, as you update and improve your code you should update relevant comments as well. The more comments you have the easier it is for your comments and code to get out of sync.  
...
Some things to consider:  
  ...
  3) If you use functions from common packages (e.g. `tidyverse` functions), you don't need repeat basic info from the help.
