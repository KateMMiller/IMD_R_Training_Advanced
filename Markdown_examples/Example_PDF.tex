...
\lhead{ \textcolor{black}{\rule[-5pt]{20.6cm}{16pt}} \hspace{-20.5cm} \vspace{-0.1cm} \color{white}\textsf{Northeast Temperate Network} \textcolor{black}{\rule[-33.5pt]{20.6cm}{42pt}} \hspace{-20.5cm} \color{white}\textsf{Inventory \& Monitoring Program} }
