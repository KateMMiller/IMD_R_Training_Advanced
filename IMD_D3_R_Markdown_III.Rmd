...
<pre class = 'noBorder'><code><p style="color:white;margin-top:-60px;"> 
```</p>
...
<br>
Then I print the plot and table using code chunks:

<pre class="r"><code><p style="margin-bottom:-40px;"> 
...
<pre class="r"><code><p style="color:white;"> 
````</p>
