...
```{markdown, verbtxt2, attr.source="style='display:inline-block;'", collapse=TRUE}
...
<br>
<a href="https://bookdown.org/yihui/rmarkdown-cookbook/">R Markdown Cookbook</a>. Another great book with Yihui Xie as an author. This book is free online and has a lot of small bite-size tips for customizing R Markdown.
<br>
