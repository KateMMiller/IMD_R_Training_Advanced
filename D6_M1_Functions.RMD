...
```{r MyFirstFunction, echo=T, eval=F}
...
```{r MyFirstFunction.3, echo=T, eval=F}
...
```{r MyFirstFunction.4, echo=T, eval=F}
mean2(x=d, na.rm=F)
...
```{r MyFirstFunction.5, echo=T, eval=F}
...
```{r MyFirstFunction.6, echo=T, eval=F}
...
```{r MyFirstFunction.7, echo=T, eval=F}
...
```{r ReadInDataFunctionals, echo=TRUE, eval=F}
...
```{r PlottingFunction.1, echo=TRUE, eval=F}
...
```{r PlottingFunction.2, echo=TRUE, eval=F}
